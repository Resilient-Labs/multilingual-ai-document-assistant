...
export async function buildCanonicalPersistPayload(
  ...
  const imageDataUrl = params.file ? await fileToDataUrl(params.file) : undefined;
...
export async function persistOCRToEntityDB(params: PersistOCRParams): Promise<void> {
