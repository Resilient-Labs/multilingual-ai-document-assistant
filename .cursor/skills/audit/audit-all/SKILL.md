...
1. Principal Engineer -> `.cursor/skills/audit/audit-principal/SKILL.md`
2. Security Auditor -> `.cursor/skills/audit/audit-security/SKILL.md`
3. DevOps Engineer -> `.cursor/skills/audit/audit-devops/SKILL.md`
4. Accessibility Auditor -> `.cursor/skills/audit/audit-a11y/SKILL.md`
5. Patterns Auditor -> `.cursor/skills/audit/audit-dry/SKILL.md`
